...
Usage:
    bench --site fdev.local execute crispy_print.dev_utils.simulate_books.simulate --kwargs "{'years': 3}"
"""
...
def quick_sim():
	...
	Usage: bench --site fdev.local execute crispy_print.dev_utils.simulate_books.quick_sim
	"""
	simulate(years=1)
...
def full_sim():
	...
	Usage: bench --site fdev.local execute crispy_print.dev_utils.simulate_books.full_sim
	"""
	simulate(years=3)
