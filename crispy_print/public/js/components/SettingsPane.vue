						...
						>
							<div class="settings-pane__grid">
								...
								<div class="settings-pane__field">
									...
									<input
										v-model.number="
											reportBuilderConfig.chart_spacing_bottom_pt
										"
										type="number"
										min="0"
										max="120"
							...
							<div class="settings-pane__subsection">
								...
								<div class="settings-pane__grid">
									...
									<div class="settings-pane__field">
										...
										<ColorInput
											v-model="tableSettings.typography.header.color"
										/>
									</div>
								</div>
							</div>
							...
							<div class="settings-pane__subsection">
								...
								<div class="settings-pane__grid">
									...
									<div class="settings-pane__field">
										...
										<ColorInput
											v-model="tableSettings.typography.body.color"
										/>
									</div>
								</div>
							</div>
