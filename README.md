...
- **Custom and Regulatory QR Workflows** - Custom Document QR stores an ordered
  list of exact Frappe fieldnames for internal/general-business payloads, while
  Regulatory Document Code resolves exclusively through permission-checked
  Document Code Profiles and the bundled jurisdiction registry.
